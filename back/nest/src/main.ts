...
async function bootstrap() {
  const httpsOptions = {
    key: fs.readFileSync('/etc/letsencrypt/live/astropong.cossetheo.com/privkey.pem'),
    cert: fs.readFileSync('/etc/letsencrypt/live/astropong.cossetheo.com/fullchain.pem'),
  };
