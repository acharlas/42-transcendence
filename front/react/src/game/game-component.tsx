...
const GameComponent: FunctionComponent<IGameComponentProps> = (props) => {
  ...
  useEffect(() => {
    ...
    function preload() {
      this.load.image("ball", "http://5.182.18.157:3001/assets/ball.png");
      if (lobby && lobby.mode === GameMode.hyperspeed) {
        this.load.image("paddle", "http://5.182.18.157:3001/assets/paddlex64.png");
      } else {
        this.load.image("paddle", "http://5.182.18.157:3001/assets/paddle.png");
      }
      this.load.image("map", "http://5.182.18.157:3001/assets/map_classic.png");
    }
