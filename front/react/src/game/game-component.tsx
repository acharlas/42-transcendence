...
const GameComponent: FunctionComponent<IGameComponentProps> = (props) => {
  ...
  useEffect(() => {
    ...
    function preload() {
      this.load.image("ball", "http://5.182.18.157:443/assets/ball.png");
      if (lobby && lobby.mode === GameMode.hyperspeed) {
        this.load.image("paddle", "http://5.182.18.157:443/assets/paddlex64.png");
      } else {
        this.load.image("paddle", "http://5.182.18.157:443/assets/paddle.png");
      }
      this.load.image("map", "http://5.182.18.157:443/assets/map_classic.png");
    }
